...
async def amireallyalive(alive):
    ...
    if CAT_IMG:
         cat_caption  = f"**🙏🙏Hello master I am RUNNING SUCCESFULLY🙏🙏**\n\n"
         cat_caption += f"**Database Status: Databases functioning normally!\n**"   
         cat_caption += f"☞Telethon version : `{version.__version__}\n`"
         cat_caption += f"☞Catuserbot Version : `{catversion}`\n"
         cat_caption += f"☞Python Version : `{python_version()}\n\n`"
         cat_caption += f"**😈😈I am always with you, my master!\n**"
        ...
        await alive.edit(f"**MY BOT IS RUNNING SUCCESFULLY**\n\n"
			 ...
			 f"☞Catuserbot Version : `{catversion}`\n"
                         ...
                         f"☞uptime : `{uptime}\n`"
                         f"☞**Click **[here](https://github.com/shoaibakhatar/catuserbot) to deply catuserbot"
                        )         
